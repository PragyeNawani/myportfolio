            ...
            <div className="px-4 w-[90%] mx-auto">
                ...
                <div className='w-full h-fit md:flex'>
                    ...
                    {profiledis === profileobj[0] && <div className="p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400  rounded-lg w-full">
                        ...
                        <div className='flex gap-3 items-center pb-2'>
                            <img src="https://cdn.pixabay.com/photo/2020/11/15/06/18/instagram-logo-5744708_640.png" className='h-[35px] w-[35px]' alt="" />
                            <a href="https://www.instagram.com/newbiecoder/" target='__blank' className='text-blue-800 hover:text-blue-500 font-bold'>@Newbiecoder (Work Related)</a>
                        </div>
                        <div className='flex gap-3 items-center pb-2'>
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Steam_icon_logo.svg/800px-Steam_icon_logo.svg.png" className='h-[35px] w-[35px]' alt="" />
                            <a href="https://steamcommunity.com/id/niishu/" target='__blank' className='text-blue-800 hover:text-blue-500 font-bold'>Nishu (Main Steam Profile)</a>
                        </div>
                    </div> }
